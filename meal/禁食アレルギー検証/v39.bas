...
SkipMatchAdd:
                        ...
                        For mi = 1 To synonymCount
                            ...
                            If InStr(1, NormalizeKana(allergyContent), NormalizeKana(masterWord), vbBinaryCompare) > 0 Then
                                ...
                                If IsFalsePositiveByContext(masterWord, allergyContent, exclusionData, exclusionCount) Then
                                    GoTo NextSynonym
                                End If
...
Public Function IsFalsePositiveByContext(ByVal masterWord As String, _
    ...
    If masterWord = "" Or allergyContent = "" Or exCount = 0 Then Exit Function
        ...
        If NormalizeKana(exData(1, i)) = normMaster Then
            ...
            If ctxList <> "" Then
                ...
                For ci = LBound(ctxs) To UBound(ctxs)
                    ...
                    If ctx <> "" Then
                        If InStr(1, normContent, NormalizeKana(ctx), vbBinaryCompare) > 0 Then
